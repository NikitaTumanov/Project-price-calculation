...
%PATH_XJAL% -version:1.6+ -cp com.xj.anylogic.engine.jar;com.xj.anylogic.engine.nl.jar;model.jar;com.xj.anylogic.engine.sa.jar -Xmx256m projectcostmodel.Simulation %*
